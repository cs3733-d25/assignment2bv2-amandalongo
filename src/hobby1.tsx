    ...
    return (
        <div className={"amandasHobby"}>
            ...
            <p>One of my favorite hobbies is doing <b>nail art</b>! I use gel-x nails and I design press ons as well as
                ...
                Below is a compilation of photos that I took of nails I've done on myself or others.
                I like doing my own nails because it saves me money and I also love how they compliment my fashion and
                add to my overall style!</p>
            <div id="nailcompilation">
                <img src="public/nailart.png" width="640" alt="nailcompilation"/>
            </div>
        </div>
    );
}